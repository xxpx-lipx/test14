...
local menu = mk("Frame", gui, {Size = ud2(0,430,0,420), AnchorPoint = v2(.5,.5), Position = getPos("Menu", ud2(.5,0,.5,0)), BackgroundTransparency = .2, BackgroundColor3 = c3(15,40,25), Visible = false, BorderSizePixel = 0, ClipsDescendants = true, ZIndex = 5})
...
local tC = mk("Frame", menu, {Size = ud2(0,75,1,-45), Position = ud2(0,10,0,35), BackgroundTransparency = 1, ZIndex = 6})
mk("UIListLayout", tC, {FillDirection = "Vertical", Padding = ud(0,5), HorizontalAlignment = "Center"})
local scr = mk("ScrollingFrame", menu, {Size = ud2(1,-95,1,-45), Position = ud2(0,90,0,35), AutomaticCanvasSize = s_y, CanvasSize = ud2(0,0,0,0), BackgroundTransparency = 1, BorderSizePixel = 0, ScrollBarThickness = 2, ZIndex = 6})
...
local function cT(n)
    local t = mk("TextButton", tC, {Size = ud2(1,0,0,25), BackgroundColor3 = c3(30,60,45), BackgroundTransparency = .5, Text = n, TextColor3 = c3(255,255,255), Font = f_gb, TextSize = 13, ZIndex = 7})
...
local function toggle()
    ...
    if v then menu.Size, menu.BackgroundTransparency, menu.Visible = ud2(0,410,0,400), 1, true end
    local t = ts:Create(menu, TweenInfo.new(v and .2 or .15), {Size = v and ud2(0,430,0,420) or ud2(0,410,0,400), BackgroundTransparency = v and .2 or 1})
...
local function createStatusUI()
    local old = lp.PlayerGui:FindFirstChild("PXHUB_StatusUI_Locked")
    if old then old:Destroy() end
